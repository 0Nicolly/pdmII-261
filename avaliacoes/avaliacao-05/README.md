...
Enquanto em um primeiro momento Wittgenstein, no Tratado Lógico Filosófico, defende que a linguagem possui uma estrutura lógica e objetiva que reflete a realidade restrita ao que pode ser verificado pelas ciências naturais, o "segundo" Wittgenstein critica sua própria visão e define a linguagem como múltipla. 
No conceito de Jogos de Linguagem, o filósofo compara a linguagem a um jogo, como xadrez ou futebol, exemplificando como cada uma possui  suas próprias regras dependendo do contexto social. Logo, o sentido de uma palavra passa a ser a forma como ela é usada dentro de um jogo de linguagem específico. 
Ainda, Wittgenstein faz uma analogia com as semelhanças de uma família, como cor dos olhos, altura, cabelo, mas que não há um único traço comum a todos, assim como ocorre na linguagem.
